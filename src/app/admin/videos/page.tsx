  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-semibold text-text">Vídeos</h1>
        <Link
                    ...
                    <div className="flex items-center gap-2 justify-end">
                      ...
                      <form action={deleteVideo}>
                        ...
                        <button
                          ...
                          onClick={(e) => {
                            if (!confirm('Eliminar este vídeo?')) e.preventDefault()
                          }}
                        >
                          <Trash2 size={14} />
                        </button>
