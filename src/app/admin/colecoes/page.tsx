  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-semibold text-text">Collections</h1>
      ...
      {collections && collections.length > 0 ? (
        <div className="bg-surface border border-border rounded-2xl p-4">
          <p className="text-xs text-text-muted mb-4">Drag to reorder</p>
          <CollectionOrderer
        ...
        <div className="text-center py-16 text-text-muted">
          No collections yet.{' '}
          <Link href="/admin/colecoes/nova" className="text-primary hover:underline">Create the first one</Link>
        </div>
      )}
    </div>
  )
