  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-semibold text-text">Recipes</h1>
            ...
            <tbody>
              ...
              {(!recipes || recipes.length === 0) && (
                <tr><td colSpan={5} className="px-4 py-8 text-center text-text-muted">
                  No recipes yet. <Link href="/admin/receitas/novo" className="text-primary hover:underline">Add the first recipe</Link>
                </td></tr>
              )}
            </tbody>
          </table>
